...
import { CardActionArea, Grid, Card, CardContent, Button, Box, Typography, Alert } from '@mui/material';
  ...
  return (
    <Box>
      ...
      <Typography variant="subtitle1" sx={{ my: 2 }}>
        Learn everything about landing an internship from our hand-picked resouces!
      </Typography>
      <Alert
        action={
          <Button color="primary" variant='contained' component={RouterLink} to="/resume/s1">
            Generate Resume
          </Button>
        }
        severity="info"
        variant='filled'
      >
        Use our Resume Generator to quickly and easily create a stand-out resume!
      </Alert>
